...
const httpRequest = async (
	...
	// TODO: deconflict this rate limit retry with the logic in the mirror test code
...
export const run = async (
	...
	const instance = integration.create({
		errors,
		token,
		...
		context: {
			...
			request: async (actor: any, requestOptions: any) => {
				assert.INTERNAL(
					null,
					actor,
					errors.SyncNoActor,
